...
| `https://aisearch.global/insights/aisearch-global-client-zero` | `insights/aisearch-global-client-zero.html` (locked — edit only on explicit request) |
| `https://aisearch.global/insights/client-zero-visibility-dashboard` | `insights/client-zero-visibility-dashboard.html` (locked — edit only on explicit request, standalone page, no main.js) |
...
| `https://aisearch.global/news` | `news/index.html` (generated daily by `automation/ai-news/generate_brief.py` — do not hand-edit) |
...
See `docs/redirects-guide.md` for how new pages get their clean URL.
